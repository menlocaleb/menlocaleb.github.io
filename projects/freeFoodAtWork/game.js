 ...
 * SPRITES
 ***********************************************************************/
function __chair_sprite() { 
__sprite_init__(this, chair_sprite, 64, 64, 0, 0, 'Box', 64, 1, 63, 1, 63, ['img/chair_sprite_0.png']);
}; var chair_sprite = new __chair_sprite();

function __wall_tile() { 
__sprite_init__(this, wall_tile, 32, 32, 0, 0, 'Box', 16, 0, 32, 0, 32, ['img/wall_tile_0.png']);
}; var wall_tile = new __wall_tile();

function __pizza() { 
__sprite_init__(this, pizza, 32, 32, 0, 0, 'Circle', 16, 0, 32, 0, 32, ['img/pizza_0.png']);
}; var pizza = new __pizza();

function __clippy() { 
__sprite_init__(this, clippy, 64, 64, 0, 0, 'Box', 32, 0, 64, 0, 64, ['img/clippy_0.png']);
}; var clippy = new __clippy();
 ...
 * FONTS
 ***********************************************************************/
function __scoreBoardFont() { 
__font_init__(this, scoreBoardFont, 'Arial', 20, 1, 0)}; var scoreBoardFont = new __scoreBoardFont();
 ...
 ***********************************************************************/
function __chair() {
__instance_init__(this, chair, null, 1, 0, chair_sprite, 1, 0);
this.on_creation = function() {
with(this) {

draw_text(5, 5, "Amount of free food:");
}
};
...
with(this) {
this.other = this.place_meeting(this.x, this.y, wall);
if(this.other != null) {
x = xprevious;
y = yprevious;
}
...
}; var chair = new __chair();

function __wall() {
__instance_init__(this, wall, null, 1, 0, wall_tile, 1, 1);
...
function __pizza_obj() {
__instance_init__(this, pizza_obj, null, 1, 0, pizza, 1, 2);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = on_step_i;
this.on_end_step = on_end_step_i;
this.on_collision = function() {
with(this) {
this.other = this.place_meeting(this.x, this.y, chair);
if(this.other != null) {
amountFreeFood += foodValues[PIZZA];

console.log(amountFreeFood);
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var pizza_obj = new __pizza_obj();

function __scoreboard() {
__instance_init__(this, scoreboard, null, 1, 0, null, 1, 3);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = on_step_i;
this.on_end_step = on_end_step_i;
...
draw_text(10, 10, "Current Free Food: " + amountFreeFood);
}
}
};
}; var scoreboard = new __scoreboard();

function __clippy_obj() {
__instance_init__(this, clippy_obj, null, 1, 0, clippy, 1, 130);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
var listOfChairs = instance_list(chair);
var theChair = listOfChairs[0];

// separate movements so that clippy will move parallel to target if wall in way
if (clippyNowMovingXOrY) {
	move_towards_point(theChair.x, y, clippySpeed);
	clippyNowMovingXOrY = !clippyNowMovingXOrY;
} else {
	move_towards_point(x, theChair.y, clippySpeed);
	clippyNowMovingXOrY = !clippyNowMovingXOrY;
}
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var clippy_obj = new __clippy_obj();

function __gameOverText() {
__instance_init__(this, gameOverText, null, 1, 0, null, 1, 132);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = on_step_i;
this.on_end_step = on_end_step_i;
...
[{o:wall, x:192, y:128}],
[{o:chair, x:192, y:224}],
[{o:pizza_obj, x:480, y:384}],
[{o:pizza_obj, x:256, y:128}],
[{o:pizza_obj, x:128, y:128}],
[{o:pizza_obj, x:64, y:512}],
[{o:pizza_obj, x:608, y:544}],
[{o:pizza_obj, x:608, y:96}],
[{o:pizza_obj, x:224, y:384}],
[{o:pizza_obj, x:320, y:224}],
[{o:clippy_obj, x:365, y:496}],
[{o:gameOverText, x:620, y:20}]];
this.start = function() {
__room_start__(this, scene1, 1080, 720, 30, 255, 254, 255, null, 0, 0, 0, 1080, 720, null, 50, 50);
};
}
var scene1 = new __scene1();
tu_scenes.push(scene1);
tu_room_to_go = scene1;
...
var amountFreeFood = 0;

var clippyNowMovingXOrY = 0; // 1 = x, 0 = y
